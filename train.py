...
if 1:
    ...
    # Dataset.
    desc += '/kaggle/working/stylegan/datasets/custom-dataset'= EasyDict(tfrecord_dir='/kaggle/working/stylegan/datasets/custom-dataset'); train.mirror_augment = True
